...
(function () {
  ...
  function renderForm () {
    ...
    const privLockedNote = privLocked ? `
      <div class="bw-wa-box" style="margin-bottom:20px;">
        <p>This time is already partly booked, so the <strong>private experience</strong> can't be reserved online for this slot. Message us — we may still be able to arrange a private hunt for your group.</p>
